#include "Sensors.h"
#define DATOS_A_ENVIAR 4 //Numero de medidas a enviar al servidor REST (Entre 1 y 8)
...
void loop() {
    ...
    //data[5] = String(); //Se envía el dato de iluminación
...
*/
  ...
  String tmpMovement=readPosition();
  if(tmpMovement.length()>0){
